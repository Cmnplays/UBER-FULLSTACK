...
const FinishRide = (props) => {
  return (
    <div>
      ...
      <div className="flex items-center justify-between p-4 rounded-lg mt-4 border-2 border-yellow-400 bg-yellow-400">
      ...
      <div className="flex justify-between flex-col gap-2 items-center">
        ...
        <div className="mt-5 w-full">
          ...
          <p className="mt-10 text-xs p-3">
            Click on finish ride button if the payment is completed.
          </p>
        </div>
      </div>
    </div>
